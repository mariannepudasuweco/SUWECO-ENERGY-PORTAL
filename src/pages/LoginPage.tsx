      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 text-sm text-center">
            Enter your Supabase login credentials.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              } text-white px-5 py-3.5 rounded-xl focus:outline-none focus:border-[#f5a623] transition-colors`}
              autoFocus
              required
            />
          </div>
        ...
        <div className="mt-6 text-center">
          <a
            href="/"
            className="text-gray-400 hover:text-white text-sm transition-colors border-b border-transparent hover:border-white"
          >
            ← Back to Home
          </a>
        </div>
