...
// We simulate what updateProjectScheduleStats does.
const combinedOptions = [
    'A1 - BIDDING DOCUMENTS',
    'A2 - BIDDING SECURITY',
    'B1 - LAND ACQUISITION',
    'B2 - Permitting',
    'B2.1 - LGU',
...
let sumLeafProgress = 0;
let countLeafTasks = 0;
...
allCodes.forEach(code => {
    ...
    if (isLeaf[code]) {
        ...
        taskProg = Math.max(0, Math.min(100, taskProg));
